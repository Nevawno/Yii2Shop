				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
                            ...
                            <?= yii\helpers\Html::img('@web/images/home/logo.png', ['alt' => 'eshopper']);?>
                        </a>
						</div>
					...
					<div class="col-sm-9">
						...
						<div class="mainmenu pull-left">
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li class="#"><a href="#">Категории<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
                                        <li><a href="<?= yii\helpers\Url::to(['category/index']);?>">Список категорий</a></li>
										<li><a href="<?= yii\helpers\Url::to(['category/create']);?>">Добавить категорю</a></li> 
                                    </ul>
                                </li> 
